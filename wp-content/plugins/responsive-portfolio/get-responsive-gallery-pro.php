<div class="row-fluid pricing-table pricing-three-column" style="margin-top: 10px;display:block;width:100%;overflow:hidden">
	...
	<div class="purchase_btn_div" style="margin-top:20px;text-align: center;">
	  <a  style= "margin-right:10px;" href="http://demo.weblizar.com/responsive-portfolio-pro/" target="_new" class="btn btn-primary btn-lg">View Demo</a>
	  <a style= "margin-right:10px;" href="http://weblizar.com/plugins/responsive-portfolio-pro/" target="_new" class="btn btn-success btn-lg">Try Before Buy</a>
	  <a href="http://weblizar.com/plugins/responsive-portfolio-pro/" target="_new" class="btn btn-danger btn-lg">Upgrade To Pro</a>
		
	</div>
	
	<div class="plan-name" style="margin-top:40px;text-align: center;">
        <h2 style="font-weight: bold;font-size: 36px;padding-top: 30px;padding-bottom: 10px;">Responsive Portfolio Pro Screenshots</h2>
...
<div class="plan-name" style="padding-top:40px; text-align: center;display:block;width:100%;overflow:hidden">
	...
	<div class="purchase_btn_div" style="margin-top:20px;text-align: center;">
	  ...
	  <a style= "margin-right:10px;" href="http://demo.weblizar.com/responsive-photo-gallery-admin-demo/" target="_new" class="btn btn-success btn-lg">Try Before Buy</a>
	  <a href="http://demo.weblizar.com/responsive-photo-gallery-admin-demo/" target="_new" class="btn btn-danger btn-lg">Upgrade To Pro</a>
	...
	<div class="col-md-4">
		<div class=" plan ap">
			...
			<ul>
				...
				<li class="plan-feature">Video Gallery</li>
				<li class="plan-feature">Carousel Slider</li>
				<li class="plan-feature">Album View</li>
		...
		<div class=" plan bp">
			...
			<ul>
				...
				<li class="plan-feature">
					<a  href="#" class="button button-primary button-hero" ><i class="fa fa-download"></i> Download</a>
				</li>
			</ul>
		</div>
	</div>
	...
	<div class="col-md-4">
		<div class=" plan cp">
			...
			<ul>
				...
				<li class="plan-feature"><i class="fa fa-check fa-1x"></i></li>
				<li class="plan-feature">
					<a class="btn btn-primary btn-lg" target="_new" href="http://demo.weblizar.com/responsive-portfolio-pro/" target="_new" ><i class="fa fa-check-circle"></i> Demo</a>
					<a class="btn btn-danger btn-lg" target="_new" href="http://weblizar.com/plugins/responsive-portfolio-pro/"  ><i class="fa fa-shopping-cart"></i> Buy</a>
				</li>
			</ul>
		</div>
	</div>	
