...
'sender_subscribed_as_a_client' => array('type' => 'text', 'modules' => array('registration-as-a-client'), 'name' => __('Senders registered as clients', 'contact-manager'), 'width' => 18),
...
'sender_subscribed_to_affiliate_program' => array('type' => 'text', 'modules' => array('registration-to-affiliate-program'), 'name' => __('Senders registered to the affiliate program', 'contact-manager'), 'width' => 18),
...
'sender_subscribed_as_a_user' => array('type' => 'text', 'modules' => array('wordpress'), 'name' => __('Senders registered as users', 'contact-manager'), 'width' => 18),
...
'user_agent' => array('type' => 'text', 'modules' => array('sender'), 'name' => __('Browser', 'contact-manager'), 'width' => 24),
