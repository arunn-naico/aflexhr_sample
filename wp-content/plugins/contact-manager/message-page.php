...
<td><textarea style="padding: 0 0.25em; height: 1.75em; width: 25%;" name="form_id" id="form_id" rows="1" cols="25" onkeyup="<?php if (!isset($_GET['id'])) { echo "this.setAttribute('data-changed', 'yes'); "; } ?>if (this.value != '') { update_form(this.form); }" onchange="<?php if (!isset($_GET['id'])) { echo "this.setAttribute('data-changed', 'yes'); "; } ?>update_form(this.form);"><?php echo $_POST['form_id']; ?></textarea>
...
<td><textarea style="padding: 0 0.25em; height: 1.75em; width: 75%;" name="receiver" id="receiver" rows="1" cols="75" onchange="<?php if (!isset($_GET['id'])) { echo "this.setAttribute('data-changed', 'yes'); "; } ?>update_form(this.form);"><?php echo $_POST['receiver']; ?></textarea></td></tr>
...
<td><textarea style="padding: 0 0.25em; height: 1.75em; width: 75%;" name="subject" id="subject" rows="1" cols="75" onchange="<?php if (!isset($_GET['id'])) { echo "this.setAttribute('data-changed', 'yes'); "; } ?>update_form(this.form);"><?php echo $_POST['subject']; ?></textarea></td></tr>
...
<td><textarea style="float: left; margin-right: 1em; width: 75%;" name="content" id="content" rows="10" cols="75" onchange="<?php if (!isset($_GET['id'])) { echo "this.setAttribute('data-changed', 'yes'); "; } ?>update_form(this.form);"><?php echo $_POST['content']; ?></textarea></td></tr>
...
<td><textarea style="padding: 0 0.25em; height: 1.75em; width: 75%;" name="keywords" id="keywords" rows="1" cols="75" onchange="<?php if (!isset($_GET['id'])) { echo "this.setAttribute('data-changed', 'yes'); "; } ?>update_form(this.form);"><?php echo $_POST['keywords']; ?></textarea><br />
...
<td><input class="date-pick" type="text" name="date" id="date" size="20" value="<?php echo ($_POST['date'] != '' ? $_POST['date'] : $current_date); ?>" onchange="<?php if (!isset($_GET['id'])) { echo "this.setAttribute('data-changed', 'yes'); "; } ?>update_form(this.form);" /></td></tr>
...
<td><textarea style="padding: 0 0.25em; height: 1.75em; width: 50%;" name="first_name" id="first_name" rows="1" cols="50" onchange="<?php if (!isset($_GET['id'])) { echo "this.setAttribute('data-changed', 'yes'); "; } ?>update_form(this.form);"><?php echo $_POST['first_name']; ?></textarea></td></tr>
...
<td><textarea style="padding: 0 0.25em; height: 1.75em; width: 50%;" name="last_name" id="last_name" rows="1" cols="50" onchange="<?php if (!isset($_GET['id'])) { echo "this.setAttribute('data-changed', 'yes'); "; } ?>update_form(this.form);"><?php echo $_POST['last_name']; ?></textarea></td></tr>
...
<td><textarea style="padding: 0 0.25em; height: 1.75em; width: 50%;" name="email_address" id="email_address" rows="1" cols="50" onchange="<?php if (!isset($_GET['id'])) { echo "this.setAttribute('data-changed', 'yes'); "; } ?>update_form(this.form);"><?php echo $_POST['email_address']; ?></textarea></td></tr>
...
<td><textarea style="padding: 0 0.25em; height: 1.75em; width: 50%;" name="website_name" id="website_name" rows="1" cols="50" onchange="<?php if (!isset($_GET['id'])) { echo "this.setAttribute('data-changed', 'yes'); "; } ?>update_form(this.form);"><?php echo $_POST['website_name']; ?></textarea> 
...
<td><textarea style="padding: 0 0.25em; height: 1.75em; width: 75%;" name="website_url" id="website_url" rows="1" cols="75" onkeyup="update_links(this.form);" onchange="<?php if (!isset($_GET['id'])) { echo "this.setAttribute('data-changed', 'yes'); "; } ?>update_links(this.form); update_form(this.form);"><?php echo $_POST['website_url']; ?></textarea> 
...
<td><textarea style="padding: 0 0.25em; height: 1.75em; width: 50%;" name="address" id="address" rows="1" cols="50" onchange="<?php if (!isset($_GET['id'])) { echo "this.setAttribute('data-changed', 'yes'); "; } ?>update_form(this.form);"><?php echo $_POST['address']; ?></textarea></td></tr>
...
<td><textarea style="padding: 0 0.25em; height: 1.75em; width: 50%;" name="postcode" id="postcode" rows="1" cols="50" onchange="<?php if (!isset($_GET['id'])) { echo "this.setAttribute('data-changed', 'yes'); "; } ?>update_form(this.form);"><?php echo $_POST['postcode']; ?></textarea></td></tr>
...
<td><textarea style="padding: 0 0.25em; height: 1.75em; width: 50%;" name="town" id="town" rows="1" cols="50" onchange="<?php if (!isset($_GET['id'])) { echo "this.setAttribute('data-changed', 'yes'); "; } ?>update_form(this.form);"><?php echo $_POST['town']; ?></textarea></td></tr>
...
<td><textarea style="padding: 0 0.25em; height: 1.75em; width: 50%;" name="country" id="country" rows="1" cols="50" onkeyup="update_country_code(this.form);" onchange="<?php if (!isset($_GET['id'])) { echo "this.setAttribute('data-changed', 'yes'); "; } ?>update_country_code(this.form); update_form(this.form);"><?php echo $_POST['country']; ?></textarea>
<span style="vertical-align: 25%; margin-left: 2em;"><label style="font-weight: bold;" for="country_code"><?php _e('Country code', 'contact-manager'); ?></label> <select style="font-family: Consolas, Monaco, monospace; margin-left: 0.5em; max-width: 10em;" name="country_code" id="country_code" onkeyup="update_country(this.form);" onchange="<?php if (!isset($_GET['id'])) { echo "this.setAttribute('data-changed', 'yes'); "; } ?>update_country(this.form); update_form(this.form);">
...
<td><textarea style="padding: 0 0.25em; height: 1.75em; width: 50%;" name="phone_number" id="phone_number" rows="1" cols="50" onchange="<?php if (!isset($_GET['id'])) { echo "this.setAttribute('data-changed', 'yes'); "; } ?>update_form(this.form);"><?php echo $_POST['phone_number']; ?></textarea></td></tr>
...
<td><textarea style="padding: 0 0.25em; height: 1.75em; width: 50%;" name="ip_address" id="ip_address" rows="1" cols="50" onchange="<?php if (!isset($_GET['id'])) { echo "this.setAttribute('data-changed', 'yes'); "; } ?>update_form(this.form);"><?php echo $_POST['ip_address']; ?></textarea></td></tr>
...
<td><textarea style="padding: 0 0.25em; height: 1.75em; width: 75%;" name="user_agent" id="user_agent" rows="1" cols="75" onchange="<?php if (!isset($_GET['id'])) { echo "this.setAttribute('data-changed', 'yes'); "; } ?>update_form(this.form);"><?php echo $_POST['user_agent']; ?></textarea></td></tr>
...
<td><textarea style="padding: 0 0.25em; height: 1.75em; width: 75%;" name="referring_url" id="referring_url" rows="1" cols="75" onkeyup="update_links(this.form);" onchange="<?php if (!isset($_GET['id'])) { echo "this.setAttribute('data-changed', 'yes'); "; } ?>if (this.value == '') { this.form.referring_url_emptied.value = 'yes'; } update_links(this.form); update_form(this.form);"><?php echo $_POST['referring_url']; ?></textarea><input type="hidden" name="referring_url_emptied" value="no" /> 
...
<td><textarea style="padding: 0 0.25em; '.($rows == 1 ? 'height: 1.75em; ' : '').'width: 75%;" name="custom_field_'.$key.'" id="custom_field_'.$key.'" rows="'.$rows.'" cols="75" onkeyup="update_links(this.form);" onchange="'.(!isset($_GET['id']) ? "this.setAttribute('data-changed', 'yes'); " : "").'update_links(this.form); update_form(this.form);">'.htmlspecialchars($field_value).'</textarea>
...
<td><textarea style="padding: 0 0.25em; height: 1.75em; width: 50%;" name="referrer" id="referrer" rows="1" cols="50" onkeyup="<?php if (!isset($_GET['id'])) { echo "this.setAttribute('data-changed', 'yes'); "; } ?>if (this.value == '') { this.form.referrer_emptied.value = 'yes'; } update_form(this.form);" onchange="<?php if (!isset($_GET['id'])) { echo "this.setAttribute('data-changed', 'yes'); "; } ?>if (this.value == '') { this.form.referrer_emptied.value = 'yes'; } update_form(this.form);"><?php echo $_POST['referrer']; ?></textarea><input type="hidden" name="referrer_emptied" value="no" />
...
<td><textarea style="padding: 0 0.25em; height: 1.75em; width: 25%;" name="commission_amount" id="commission_amount" rows="1" cols="25" onchange="<?php if (!isset($_GET['id'])) { echo "this.setAttribute('data-changed', 'yes'); "; } ?>update_form(this.form);"><?php echo number_format((float) $_POST['commission_amount'], 2, '.', ''); ?></textarea> <span style="vertical-align: 25%;"><?php echo $currency_code; ?></span> 
...
<td><select name="commission_status" id="commission_status" onchange="if (this.value == 'paid') { document.getElementById('commission-payment-date').style.display = ''; } else { document.getElementById('commission-payment-date').style.display = 'none'; } <?php if (!isset($_GET['id'])) { echo "this.setAttribute('data-changed', 'yes'); "; } ?>update_form(this.form);">
...
<td><input class="date-pick" type="text" name="commission_payment_date" id="commission_payment_date" size="20" value="<?php echo $_POST['commission_payment_date']; ?>" onchange="<?php if (!isset($_GET['id'])) { echo "this.setAttribute('data-changed', 'yes'); "; } ?>update_form(this.form);" />
...
<td><textarea style="padding: 0 0.25em; height: 1.75em; width: 50%;" name="referrer2" id="referrer2" rows="1" cols="50" onkeyup="<?php if (!isset($_GET['id'])) { echo "this.setAttribute('data-changed', 'yes'); "; } ?>if (this.value == '') { this.form.referrer2_emptied.value = 'yes'; } update_form(this.form);" onchange="<?php if (!isset($_GET['id'])) { echo "this.setAttribute('data-changed', 'yes'); "; } ?>if (this.value == '') { this.form.referrer2_emptied.value = 'yes'; } update_form(this.form);"><?php echo $_POST['referrer2']; ?></textarea><input type="hidden" name="referrer2_emptied" value="no" />
...
<td><input class="date-pick" type="text" name="commission2_payment_date" id="commission2_payment_date" size="20" value="<?php echo $_POST['commission2_payment_date']; ?>" onchange="<?php if (!isset($_GET['id'])) { echo "this.setAttribute('data-changed', 'yes'); "; } ?>update_form(this.form);" />
...
<tr style="vertical-align: top;"><th scope="row" style="width: 20%;"></th>
<td><label><input type="checkbox" name="sender_subscribed_as_a_client" id="sender_subscribed_as_a_client" value="yes"<?php if ($_POST['sender_subscribed_as_a_client'] == 'yes') { echo ' checked="checked"'; } ?> onchange="this.setAttribute('data-changed', 'yes'); update_form(this.form);" /> 
...
<td><select name="sender_client_category_id" id="sender_client_category_id" onchange="this.setAttribute('data-changed', 'yes'); update_form(this.form);">
...
<?php } else { echo str_replace('<a', '<a '.$documentations_links_markup, __('To use affiliation, you must have installed and activated <a href="http://www.kleor.com/affiliation-manager/">Affiliation Manager</a>.', 'contact-manager')); } ?></span></td></tr>
<tr style="vertical-align: top;"><th scope="row" style="width: 20%;"></th>
<td><label><input type="checkbox" name="sender_subscribed_to_affiliate_program" id="sender_subscribed_to_affiliate_program" value="yes"<?php if ($_POST['sender_subscribed_to_affiliate_program'] == 'yes') { echo ' checked="checked"'; } ?> onchange="this.setAttribute('data-changed', 'yes'); update_form(this.form);" /> 
...
<td><select name="sender_affiliate_category_id" id="sender_affiliate_category_id" onchange="this.setAttribute('data-changed', 'yes'); update_form(this.form);">
...
<tr style="vertical-align: top;"><th scope="row" style="width: 20%;"></th>
<td><label><input type="checkbox" name="sender_subscribed_to_members_areas" id="sender_subscribed_to_members_areas" value="yes"<?php if ($_POST['sender_subscribed_to_members_areas'] == 'yes') { echo ' checked="checked"'; } ?> onchange="this.setAttribute('data-changed', 'yes'); update_form(this.form);" /> 
...
<td><textarea style="float: left; margin-right: 1em; width: 50%;" name="sender_members_areas_modifications" id="sender_members_areas_modifications" rows="2" cols="50" onchange="this.setAttribute('data-changed', 'yes'); update_form(this.form);"><?php echo $_POST['sender_members_areas_modifications']; ?></textarea>
...
<td><select name="sender_member_category_id" id="sender_member_category_id" onchange="this.setAttribute('data-changed', 'yes'); update_form(this.form);">
...
jQuery.post("'.CONTACT_MANAGER_URL.'index.php?action=update-form&page='.$_GET['page'].(isset($_GET['id']) ? '&id='.$_GET['id'] : '').'&time='.$current_time.'&key='.md5(AUTH_KEY).'", data, function(data) {
