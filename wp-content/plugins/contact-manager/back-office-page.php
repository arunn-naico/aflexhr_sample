...
<span style="vertical-align: 25%;"><a id="custom-icon-url-link" target="<?php echo $options['urls_fields_links_target']; ?>" href="<?php echo htmlspecialchars(kleor_format_url(do_shortcode($options['custom_icon_url']))); ?>"><?php _e('Link', 'contact-manager'); ?></a>
